...
@ContextConfiguration(classes = {  
		GQLServletController.class,
		GraphiQLAutoConfiguration.class, Query.class }) 
...
public class GraphiqlCsrfEnabledTest {
	...
	public void testGetBook() throws Exception { 
		...
		graphqlresultTmp.andExpect(status().isOk())
	...
	private ResultActions doGraphQLRequest(String qPar) throws Exception {
		...
		MockHttpServletRequestBuilder getTMP = 
				post(GRAPHQL_API_PATH)
